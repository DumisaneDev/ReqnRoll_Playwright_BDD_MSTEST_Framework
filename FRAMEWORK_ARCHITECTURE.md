...
Everything starts with the business rules. We write these in plain language so everyone—from Project Managers to Developers—understands what is being tested.

### **2. Automation Logic (Orange Layer)**
The "Glue" that connects the business language to the actual automation script. It ensures that when a stakeholder says *"When I click login"*, the computer knows exactly which button to find.
...
*   **Technical Logs:** Detailed execution history for deeper analysis.
